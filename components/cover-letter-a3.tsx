...
export const CoverLetterA3 = forwardRef<CoverLetterHandle, CoverLetterA3Props>(
  ({ data, onChange, setIsGenerating }, ref) => {
    ...
    const handleDownload = async () => {
      ...
      try {
        ...
        pdf.save(`Anschreiben_${data.personalInfo.lastName}_Professional.pdf`);
      } finally {
      ...
      <div className="h-full overflow-y-auto bg-slate-900/30">
        <div className="p-4 sm:p-6 lg:p-8">
          ...
          <div
            ...
            style={{ width: "210mm", minHeight: "297mm", backgroundColor: "#f0f4f8" }}
          >
            <div ref={previewRef} className="p-12" style={{ fontFamily: data.fontFamily || "Montserrat", color: "#1e3a5f" }}>
              {/* Header */}
              <div className="mb-12 pb-6" style={{ borderBottom: "3px solid #2563eb" }}>
                <h1 className="text-4xl font-bold mb-2" style={{ color: "#1e3a5f" }}>
                  {data.personalInfo.firstName} {data.personalInfo.lastName}
                </h1>
                <p className="text-lg" style={{ color: "#3b82f6" }}>{data.personalInfo.title}</p>
                <div className="flex gap-4 mt-4 text-sm" style={{ color: "#475569" }}>
              ...
              {/* Recipient */}
              <div className="mb-8 text-sm" style={{ color: "#334155" }}>
                <div
                  contentEditable
              ...
              {/* Date & Location */}
              <div className="text-right mb-8 text-sm" style={{ color: "#475569" }}>
                <span
                  contentEditable
                  suppressContentEditableWarning
                  className="outline-none"
              ...
              {/* Body */}
              <div className="space-y-4 text-sm leading-relaxed" style={{ color: "#1e3a5f" }}>
                <p
                  contentEditable
                  suppressContentEditableWarning
                  className="outline-none"
                  ...
                  <div>
                    {data.signatureImageUrl ? (
                      ...
                      <div
                        ...
                        style={{ fontFamily: `'${data.signatureFont}', cursive`, color: "#2563eb" }}
                      >
                        {data.signatureName}
                      </div>
                    ) : null}
...
CoverLetterA3.displayName = "CoverLetterA3";
