...
export function CoverLetterA6({ data, onChange }: CoverLetterA6Props) {
    ...
    <div className="h-full overflow-y-auto bg-slate-900/30">
      <div className="p-4 sm:p-6 lg:p-8 space-y-6">
        ...
        <div className="bg-white mx-auto shadow-2xl" style={{ width: "210mm", minHeight: "297mm" }}>
          <div ref={previewRef} className="flex" style={{ fontFamily: data.fontFamily || "Arial", minHeight: "297mm" }}>
