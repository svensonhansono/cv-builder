...
export function CoverLetterA5({ data, onChange }: CoverLetterA5Props) {
      ...
      <div className="p-4 sm:p-6 lg:p-8">
        ...
        >
          <div ref={previewRef} className="flex">
            ...
            <div className="w-[60mm] bg-gray-200 p-8" style={{ fontFamily: data.fontFamily || "Arial" }}>
              <div className="mb-8">
            ...
            {/* Right Content - White */}
            <div className="flex-1 p-12" style={{ fontFamily: data.fontFamily || "Arial", color: "#2d3748" }}>
              {/* Recipient */}
