...
export const CoverLetterA7 = forwardRef<CoverLetterHandle, CoverLetterA7Props>(
      ...
      <div className="h-full overflow-y-auto bg-slate-900/30">
        <div className="p-4 sm:p-6 lg:p-8 space-y-6">
          ...
          <div className="bg-white mx-auto shadow-2xl" style={{ width: "210mm", minHeight: "297mm" }}>
            <div ref={previewRef} className="p-16" style={{ fontFamily: data.fontFamily || "Montserrat", color: "#1e293b" }}>
...
CoverLetterA7.displayName = "CoverLetterA7";
