...
export function CoverLetterA2({ data, onChange }: CoverLetterA2Props) {
        ...
        >
          <div ref={previewRef} className="flex">
            ...
            <div className="w-[60mm] p-10" style={{ backgroundColor: "#f5f1e8" }}>
              <div className="space-y-4 text-sm" style={{ color: "#4a4a4a", fontFamily: data.fontFamily || "Arial" }}>
                <div className="flex items-center gap-3">
            ...
            {/* Right Content - White */}
            <div className="flex-1 p-12 pt-16" style={{ fontFamily: data.fontFamily || "Arial", color: "#2d2d2d" }}>
              {/* Large Name */}
              <div className="mb-16">
